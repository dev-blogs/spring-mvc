INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (1, 'user1', 'user1', '2016-07-01', 'This is user1');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (2, 'user2', 'user2', '2016-01-20', 'This is user2');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (3, 'user3', 'user3', '2016-03-03', 'This is user3');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (4, 'vasya', 'vasya', '2016-07-10', 'This is vasya');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (5, 'petya', 'petya', '2016-05-01', 'This is petya');

INSERT INTO ROLES (ID, USER_ROLE, DESCRIPTION) VALUES (1, 'ROLE_USER', 'user role');
INSERT INTO ROLES (ID, USER_ROLE, DESCRIPTION) VALUES (2, 'ROLE_ADMIN', 'admin role');
