INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (1, 'user1', 'user1', '2016-07-01', 'its user1');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (2, 'user2', 'user2', '2016-01-20', 'its user2');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (3, 'user3', 'user3', '2016-03-03', 'its user3');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (4, 'vasya', 'vasya', '2016-07-10', 'its vasya');
INSERT INTO USERS (ID, LOGIN, PASSWORD, DATE_OF_REGISTRATION, DESCRIPTION) VALUES (5, 'petya', 'petya', '2016-05-01', 'its petya');
